...
import { renderAgentCoreSystemPrompt } from './agent-core-prompt-renderer'
...
export async function buildAgentCoreContext(
  ...
  const shellExecutionBackend = options.shellExecutionBackend ?? localAgentCoreShellExecutionBackend
