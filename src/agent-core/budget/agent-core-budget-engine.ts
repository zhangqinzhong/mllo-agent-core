...
export const DEFAULT_AGENT_CORE_BUDGET_POLICY: AgentCoreBudgetPolicy = {
  ...
  microCompactPreservedRecentToolResults: 4,
  microCompactToolResultChars: 1_000,
  toolResultProfiles: {
    shell_command: {
      maxToolResultChars: 12_000,
      preservedToolResultHeadChars: 3_000,
      preservedToolResultTailChars: 5_000,
      microCompactToolResultChars: 1_200,
    },
    grep_files: {
      maxToolResultChars: 8_000,
      preservedToolResultHeadChars: 7_000,
      preservedToolResultTailChars: 500,
      microCompactToolResultChars: 800,
    },
    read_file: {
      maxToolResultChars: 16_000,
      preservedToolResultHeadChars: 10_000,
      preservedToolResultTailChars: 2_000,
