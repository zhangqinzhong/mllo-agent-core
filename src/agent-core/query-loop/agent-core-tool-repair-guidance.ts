...
function repairHintsForErrorKind(args: {
  ...
  switch (args.errorKind) {
    ...
    case "permission-denied":
      return [
        "Treat this as a permission boundary, not a transient tool failure.",
        "Do not repeat the same denied call unchanged; ask the user, choose a safer alternative, or explain the blocker.",
      ];
    case "tool-error":
    case undefined:
